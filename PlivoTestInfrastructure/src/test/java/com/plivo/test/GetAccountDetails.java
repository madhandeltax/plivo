	...
	{	
		...
		try {
			response = client.execute(
			  new HttpGet("https://api.plivo.com/v1/Account/MAODUZYTQ0Y2FMYJBLOW/"));
            ...
            cashCredits = completeObject.getString("cash_credits").replace("\"", "");
            
            System.out.println(completeObject);
      
            System.out.println(cashCredits);
