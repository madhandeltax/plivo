...
public class GetPrice extends BaseClass {
	...
	{	
		...
		try {
			response = client.execute(
			  new HttpGet("https://api.plivo.com/v1/Account/MAODUZYTQ0Y2FMYJBLOW/Pricing/?country_iso=US"));
            ...
            JsonObject message = completeObject.getJsonObject("message");
            
            JsonObject outbound = message.getJsonObject("outbound");
            
            outboundRate = outbound.getString("rate").replace("\"", "");
            
            System.out.println(outboundRate);
