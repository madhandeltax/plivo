...
public class GetMessageDetails extends BaseClass {
	...
	{	
		...
		try {
			response = client.execute(
			  new HttpGet("https://api.plivo.com/v1/Account/MAODUZYTQ0Y2FMYJBLOW/Message/"+messageUUID+"/"));
            ...
            totalRate = completeObject.getString("total_rate");
